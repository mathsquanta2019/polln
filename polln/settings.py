...
DATABASES = {
    'default': {
        ...
        'NAME': 'pollnpostgres',  # Change this to your PostgreSQL database name
        'USER': 'postgres',  # Change this to your PostgreSQL username
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD'),  # Use environment variable for security
        'HOST': 'localhost',  # Or the IP address where your PostgreSQL server is hosted
